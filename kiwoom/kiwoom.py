...
class Kiwoom(QAxWidget):
    def __init__(self):
        ...
        #####요청 스크린 번호
        self.screen_my_into = "2000" #계좌 관련한 스크린 번호
    ...
    def detail_account_info(self, sPrevNext="0"):
        ...
        self.dynamicCall("CommRqData(QString, QString, int, QString)", "예수금상세현황요청", "opw00001",sPrevNext,self.screen_my_into)
    ...
    def trdata_slot(self, sScrNo, sRQName, sTrCode, sRecordName, sPrevNext):
        if sRQName == "예수금상세현황요청":
            ...
            self.stop_screen_cancel(self.screen_my_into)
